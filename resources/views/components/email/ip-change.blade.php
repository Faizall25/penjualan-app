                                    ...
                                    <td>
                                        <div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px"
                                            ...
                                            <div
                                                ...
                                                Kami menemukan adanya login baru dari perangkat yang tidak terdaftar.
                                                Jika ini adalah anda, silahkan klik tombol di bawah ini untuk mengubah
                                                IP Anda.
                                                <div style="padding-top:32px;text-align:center">
                                                    <a href="{{ $url }}"
                                                        style="font-family: sans-serif;family: Verdana;padding: 0.5rem 1rem; background-color: rgb(0, 150, 65); color: #fff; text-decoration: none; border-radius: 5px;">Ubah
                                                        IP</a>
                                                </div>
                                            </div>
                                            <div
                                                style="font-family:Verdana,sans-serif;font-size:10px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px;text-align:center">
                                                Mohon untuk tidak menanggapi pesan ini, jika itu bukan anda
                                            </div>
                                            <div
