        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            <div class="flex items-center justify-between px-4 py-3">
                <a href="{{ route('dashboard') }}" class="main-logo flex shrink-0 items-center">
                    <!-- <img class="ml-[5px] w-8 flex-none" src="/user/assets/images/profiles/dGn.png" alt="image"> -->
                    <span
                        class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">App Penjualan</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                ...
                <h2
                    class="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-bold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                ...
                <li class="nav-item">
                    <a href="{{ route('salesman.index') }}" class="group">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Salesman</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item">
